...
class Player:
    ...
    def card_decision(self, game_mode: Game, renderer: Renderer, lead_card: Card, played_cards: list, trumps: list, called_sau: Card):
        ...
        legal = is_move_legal(game_mode=game_mode,decision=decision, player_cards=self.player_cards, lead_card=lead_card, trumps=trumps, called_sau=called_sau)
        while not legal:
